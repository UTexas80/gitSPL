...
date-1 <- SPL$date                                                                # Create date variable
date<-date-1 + 1
...
# Price
colnames(tblPrice) <- c("key","date", "open", "high", "low", "close", "volume", 
  "adjusted", "symbol", "date-1" )                                                # Rename tblPBands Table Columns
#Statistical Tables
...
# Reorder  -----------------------------------------------------------------------------------------
tblPrice <- tblPrice[, c(2, 1, 3, 11, 10, 4, 5, 6, 7, 9, 8)]                                            # Reorder tblPrice columns
