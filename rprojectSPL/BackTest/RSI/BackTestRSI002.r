# https://www.r-bloggers.com/rsi2-with-position-sizing/
...
rsi <- RSI(Cl(SPL),2) # Calculate Close-to-Close returns
...
plot.zoo(cbind(eq_up,eq_dn), plot.type = "single", 
         ylab = c("Long", "Short"), col = c("green","red"),
         main = "Updated RSI(2) Strategy With Position Scaling:n")
dev.off()
